...
export function Header() {
  ...
  return <header className="site-header"><div className="shell nav-wrap">
    <Link className="brand" href="/" aria-label="Viththiyakaran Nadarajah, home"><span className="brand-mark"><Image src="/images/viththiyakaran-avatar.png" alt="" width={256} height={256} priority /></span><strong><span className="brand-full">Viththiyakaran Nadarajah</span><span className="brand-short">Viththiyakaran</span></strong></Link>
