...
const items:Item[]=[
  {path:'/',title:'Viththiyakaran Nadarajah | Software Developer in Wales',description:site.description},
  ...
  {path:'/privacy',title:'Privacy Notice',description:'Privacy information for the Viththiyakaran Nadarajah portfolio, including contact-form data, analytics consent, retention and user choices.'},
  {path:'/cookies',title:'Cookie Notice',description:'Cookie and analytics consent information for the Viththiyakaran Nadarajah portfolio, including how to change optional analytics preferences.'},
